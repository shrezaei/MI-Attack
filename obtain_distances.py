...
parser.add_argument('-d', '--dataset', type=str, default='cifar_10', choices=['mnist', 'cifar10', 'cifar100', 'imagenet'], help='Indicate dataset and target model. If you trained your own target model, the model choice will be overwritten')
...
if __name__ == '__main__':
    ...
    # distance_save_dir = os.path.join(os.getcwd(), args.save_path)
    distance_save_dir = args.save_path
